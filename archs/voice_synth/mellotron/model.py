...
from archs.voice_synth.mellotron.layers import ConvNorm, LinearNorm
from archs.voice_synth.mellotron.utils import to_gpu, get_mask_from_lengths
from archs.voice_synth.mellotron.modules import GST

drop_rate = 0.5

def load_model(hparams, cuda_device_string):
    model = Tacotron2(hparams).to(cuda_device_string).eval()
    if hparams.fp16_run:
