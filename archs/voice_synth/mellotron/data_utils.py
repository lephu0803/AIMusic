...
import archs.voice_synth.mellotron.layers as layers
from archs.voice_synth.mellotron.utils import load_wav_to_torch, load_filepaths_and_text
from archs.voice_synth.mellotron.text import text_to_sequence, cmudict
from archs.voice_synth.mellotron.yin import compute_yin
...
class TextMelLoader(torch.utils.data.Dataset):
    ...
    """
    def __init__(self, audiopaths_and_text, hparams, speaker_ids=None, cuda_device_string="cuda:0"):
